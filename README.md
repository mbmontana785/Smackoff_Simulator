...
It's a similar concept to the NBA draft lottery, which is weighted with some teams getting more ping-pong balls than others. In this case, the probabilities gave the callers with higher probabilities a stronger chance of being picked as the predicted Smackoff winner.<br>
